...
namespace overdrive {
	namespace render {
		...
		// ~ GL_UNIFORM resource interface
		// http://docs.gl/gl4/glGetProgramResource
		class ShaderUniform {
		private:
			friend class ShaderProgram;

			ShaderUniform(const std::string& name, GLint* properties);
		...
		public:
			...
			GLint getArraySize() const;
			GLint getArrayStride() const;
			GLint getMatrixStride() const;

			GLint getOffset() const;
			GLint getBlockIndex() const;
			GLint getAtomicCounterBufferIndex() const;
		...
		std::ostream& operator << (std::ostream& os, const ShaderUniform& data);
